...
{
    public static class TestTypeGroups
    {
        ...
        public static readonly Type[] AllNonStaticTypes = BaseNonStaticTypes
            .Concat(GetCollectionTypes(BaseNonStaticTypes))
            .Concat(GetWrapperTypes(typeof(WrapperClass<>), BaseNonStaticTypes))
