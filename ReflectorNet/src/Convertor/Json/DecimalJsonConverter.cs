...
{
    /// <summary>
    /// JsonConverter that handles conversion from JSON string values to decimal type.
    /// Supports nullable decimal types.
    /// </summary>
    public class DecimalJsonConverter : JsonConverter<object>
    {
        ...
        public override object? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                throw new JsonException($"Unable to convert '{stringValue}' to {typeof(decimal).GetTypeName(pretty: true)}.");
            }
